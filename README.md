...
* [Beginning Game Programming with Go and Ebitengine](https://leanpub.com/gameprogramminggolang)- A practical, beginner-friendly guide to building 2D games with Go and Ebitengine. Learn the fundamentals of game loops, input handling, graphics, animation, audio, collisions, scenes, user interfaces, and complete game projects. The source code and examples from the book are available in the companion [GitHub repository](https://github.com/LuigiVanacore/beginning-game-programming-go-ebitengine).
